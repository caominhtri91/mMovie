# This app based on [DroidKaigi 2016 official Android conference app](https://github.com/konifar/droidkaigi2016)

## Features
* Show all movies by HOT - Trend - New
* Play movie
* Save movie in favorite list
